...
<body>
    <section class="min-h-screen flex items-stretch text-white ">
        {{-- left side --}}
        <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style="background-image: url(mainpage/img/UMPbg/canseleri.jpg);">
            <div class="absolute bg-black opacity-60 inset-0 z-0"></div>
            <div class="w-full px-24 z-10">
                <h1 class="text-5xl font-bold text-left tracking-wide">UMPCab</h1>
                <p class="text-3xl my-4">Rent cars and carpools in one place</p>
            </div>
        ...
        {{-- right side --}}
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: white;">
            <div class="absolute lg:hidden z-10 items-center" style="background-color: white">
                <div class="absolute bg-black opacity-60 inset-0 z-0"></div>
            </div>
